...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.log_text.setGeometry(QtCore.QRect(20, 310, 761, 471))
        ...
        self.label_latitude.setGeometry(QtCore.QRect(30, 160, 341, 30))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_longitude.setGeometry(QtCore.QRect(30, 200, 341, 30))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_distance.setGeometry(QtCore.QRect(30, 240, 341, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.distance.setGeometry(QtCore.QRect(370, 240, 251, 30))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.checkBox.setGeometry(QtCore.QRect(30, 270, 291, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_accuracy.setText(_translate("MainWindow", "Область карты вокруг полигона (км)"))
        self.accuracy.setText(_translate("MainWindow", "40"))
        ...
        self.latitude.setText(_translate("MainWindow", "53.231607"))
        self.label_longitude.setText(_translate("MainWindow", "Долгота (координаты полигона)"))
        self.longitude.setText(_translate("MainWindow", "45.20543"))
        self.label_distance.setText(_translate("MainWindow", "Расстояние по умолчанию (метров)"))
        self.distance.setText(_translate("MainWindow", "24000"))
        self.checkBox.setText(_translate("MainWindow", "Игнорируем шлагбаумы"))
